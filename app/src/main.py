...
if __name__ == "__main__":
    ...
    # state_map = build_geo_dataframe_from_polygons([state_polygon])
    country_map = build_geo_dataframe_from_polygons([country_polygon], True)
    # Define styles
    ...
    #
    plot_geo_dataframe([(country_map, "Layer 1", style1)], output_path)
